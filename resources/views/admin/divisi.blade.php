...
<style>
    ...
    table.modern-table th:nth-child(3) { text-align: center; } /* Aksi Tengah */
    ...
    <div class="card-box">
        ...
        <div class="welcome-card">
            ...
            <div class="welcome-text-content">
                <h3>Data Divisi</h3>
                <p>Kelola struktur departemen perusahaan.</p>
            </div>
        </div>
        ...
        <form action="{{ route('divisi.index') }}" method="GET" class="search-box">
            <input type="text"
                   name="search"
            ...
            @if(request('search'))
                <a href="{{ route('divisi.index') }}" style="text-decoration:none; color:#adb5bd; margin-left:10px; font-size:1.1rem;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <div class="action-buttons">
                                    ...
                                    <!-- Button Edit (Logika JS Anda) -->
                                    <button class="btn-action btn-edit"
                                        onclick="openModal('edit', {{ $d->id_divisi }}, '{{ $d->nama_divisi }}')">
                                        <i class="fas fa-pen"></i> Edit
                                    </button>

                                    <!-- Form Delete -->
                                    <form action="{{ route('divisi.destroy',$d->id_divisi) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn-action btn-delete" onclick="return confirm('Yakin ingin menghapus divisi ini?')">
...
<div class="modal" id="divisiModal">
    <div class="modal-content">
        <div class="modal-header">
            <h3 id="modalTitle">Tambah Divisi</h3>
        ...
        <div class="modal-body">
            <form id="divisiForm" action="{{ route('divisi.store') }}" method="POST">
                @csrf
                <input type="hidden" name="id_divisi" id="divisiId">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="divisiForm" class="btn btn-submit">Simpan Data</button>
                </div>
            </form>
        </div>
    </div>
...
<!-- JAVASCRIPT LOGIC (Sesuai Kode Asli Anda) -->
<script>
    function openModal(mode, id = null, nama_divisi = '') {
        ...
        if (mode === 'create') {
            ...
            title.innerText = "Tambah Divisi Baru";
            ...
            title.innerText = "Edit Data Divisi";
